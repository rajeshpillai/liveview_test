defmodule SocialWeb.UserAuthTest do
  use SocialWeb.ConnCase, async: true

  alias Social.Accounts
  alias SocialWeb.UserAuth
  import Social.Factory

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SocialWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SocialWeb.Endpoint.subscribe(live_socket_id)
