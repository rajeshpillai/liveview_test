defmodule SocialWeb.ComposeLiveTest do
  use SocialWeb.ConnCase, async: false
  ...
  defp last_post do
    Social.Timeline.Post |> Ecto.Query.last() |> Social.Repo.one()
  end
  ...
  defp cloud_name do
    Application.get_env(:social, :cloudinary)[:cloud_name]
  end
end
